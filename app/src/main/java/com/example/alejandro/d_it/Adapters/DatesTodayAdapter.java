    ...
    public List<Dates> parseJson(JSONArray jsonArray){
        ...
        for(int i=0;i<jsonArray.length();i++)
        {
            try
            {
                ...
                /*int total = 0;
                for (List<Dates> list : map.values()) {
                    total += list.size();
                }*/
