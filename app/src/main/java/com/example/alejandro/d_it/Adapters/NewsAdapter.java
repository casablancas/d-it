...
import com.example.alejandro.d_it.Models.News;
...
public class NewsAdapter extends ArrayAdapter {
    ...
    private static final String URL_BASE = "https://api.mlab.com/api/1/databases/d-it/collections";
    private static final String URL_JSON = "/news?apiKey=2BP5a7q4pHf6lMh-DFWcFQS-bCoR2CMh";
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Obtener Views
        TextView txtNew = (TextView) listItemView.
    ...
    public List<News> parseJson(JSONArray jsonArray){
        // Variables locales
