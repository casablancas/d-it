...
public class DatesTomorrowAdapter extends ArrayAdapter {
    ...
    public List<Dates> parseJson(JSONArray jsonArray){
        ...
        for(int i=0;i<jsonArray.length();i++)
        {
            int countTomorrow = jsonArray.length();
            System.out.println("Numero de citas para mañana: "+countTomorrow);
            try
            {
